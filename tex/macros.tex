...
% \newcommand{\appEqRule}{
% 	\begin{prooftree}
% 		\hypo{Γ ⊢ (e₁ ≡ e₂) : (\pii {x : t₁} {t₂})}
% 		\hypo{Γ ⊢ (e₃ ≡ e₄) : t₁}
% 		\infer2{Γ ⊢ ((\app {e₁} {e₃}) ≡ (\app {e₂} {e₄})) : {t₁}[x ≔ {e₃}]}
% 	\end{prooftree}
% }
...
% 		\hypo{Γ ⊢ (t₁ ≡ t₂) : u₁}
% 		\hypo{Γ ∪ \{x : t₁\} ⊢ (t₃ ≡ t₄) : u₂ }
% 		\infer2{ Γ ⊢ ((\pii {x : t₁} {t₃}) ≡ (\pii {x : t₂} {t₄})) : u₂ }
% 	\end{prooftree}
% }
...
% 		\hypo{Γ ⊢ (e₁ ≡ e₂) : t₁}
% 		\hypo{Γ ∪ \{ x ≡ e₁ \} ⊢ e₃ ≡ e₄ : t₂}
% 		\infer2{ Γ ⊢ ((\lett{x ≡ e₁}{e₃}) ≡ (\lett{x ≡ e₂}{e₄})) : t₂[x ≔ e₁] }
% 	\end{prooftree}
% }

% \newcommand{\letReduceRule}{
% 	\begin{prooftree}
% 		\hypo{Γ ⊢ e₁ : t₁}
% 		\hypo{Γ ∪ \{x ≡ e₁ : t₁\} ⊢ e₂ : t₂}
% 		\infer2{ Γ ⊢ ((\lett{x ≡ e₁}{e₂}) ≡ e₂[x ≔ e₁]) : t₂[x ≔ e₁]}
% 	\end{prooftree}
% }
...
% \newcommand{\betaRule}{
% 	\begin{prooftree}
% 		\hypo{Γ ⊢ (\lam {x : t₁} {e}) : (\pii {x : t₁} {t₂})}
% 		\hypo{Γ ⊢ e' : t₁ }
% 		\infer2{Γ ⊢ (\app{(\lam {x : t₁} {e})}{e'} ≡ e[x≔e']) : t₂[x≔e']}
% 	\end{prooftree}
% }
