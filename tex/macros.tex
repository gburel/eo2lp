...
\newcommand{\eoCommandSyntax}{
	\begin{array}[t]{r@{\ }l@{\ }l}
		δ & \begin{array}[t]{c@{\ }l}
			    ...
			    {∣} & \prn{\mtt{declare-parameterized-const}\ s\ \any{ρ}\ t\ \maybe{α}}                                    \\
			    {∣} & \prn{\mtt{define}\ {s} \ \maybe{\vec ρ} \ e\ \ \maybe{\mtt{:type}\,e'}}                              \\
			    {∣} & \prn{\mtt{program}\ x \ \any{ρ} \ \some{\mtt{:signature}\,\prn{\many{e}}\,e'} \ \prn{\many{e\ e'}} } \\
			    {∣} & {\color{MaterialGrey600}{\lparen}}
			    \mtt{declare-rule}\ s\ \any{ρ}\
			    % \\ & \quad \maybe{\mtt{:assumption}\,e}\
			    \\ & \quad \maybe{\mtt{:premises}\,\prn{\many{t_p}}}\
			    \\ & \quad \maybe{\mtt{:args}\,\prn{\many{t_a}}}\
			    \\ & \quad \maybe{\mtt{:requires}\,\prn{\many{\prn{t_r\ t_r'}}}}\
			    \\ & \quad \mtt{:conclusion}\,{t_c} {\color{MaterialGrey600}{\rparen}} \\
			    % {∣} & \prn{\mtt{declare-type}\ {s}\ \prn{\any e}}                                                          \\
			    % {∣} & \prn{\mtt{define-type}\ {s} \ \prn{\any e} \ e'}                                                     \\
		    \end{array}
	\end{array}
}
